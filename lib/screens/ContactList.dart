...
class ContactListState extends State<ContactList> {
      ...
      itemBuilder: (BuildContext context, int position) {
        return GestureDetector(
          ...
          onTap: () {
            ...
            navigateToDetail(this.contactList[position], 'Update  Contact');
          },
        );
      },
    );
  ...
  void navigateToDetail(Contacts contacts, String title) async {
    bool result =
        await Navigator.push(context, MaterialPageRoute(builder: (context) {
      return ContactDetail(contacts, title);
    }));
  ...
  void updateListView() {
    ...
    dbFuture.then((database) {
      Future<List<Contacts>> noteListFuture = databaseHelper.getContactList();
